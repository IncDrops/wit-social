      ...
      <div className="w-full max-w-4xl">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>Welcome to TrendSights AI. By accessing or using our application, you agree to be bound by these Terms of Use. If you do not agree with these terms, please do not use our services.</p>
            
            <h2 className="text-xl font-semibold text-foreground">1. Use of Service</h2>
            <p>TrendSights AI provides AI-powered tools for social media content generation and analysis. You are granted a non-exclusive, non-transferable, revocable license to access and use our services strictly in accordance with these terms.</p>
            ...
            <p>You are responsible for any content (e.g., text, prompts) you provide. You retain ownership of your content, but you grant TrendSights AI a worldwide, royalty-free license to use, reproduce, and process this data to provide and improve the service.</p>
            ...
            <p>In no event shall TrendSights AI, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.</p>
            ...
            <p>If you have any questions about these Terms, please contact us at support@trendsights.ai.</p>
          </CardContent>
        </Card>
      </div>
    </div>
